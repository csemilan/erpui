  ...
  useEffect(() => {
    async function getCollege() {
      const response = axios.get(
        `http://localhost:3000/api/v1/college/${collegeId}`
      );
      setCollege((await response).data);
    }
    getCollege();
  }, [collegeId]);
  ...
  const [notices, setNotices] = useState<Notice[]>([
    {
      ...
      content: "Scheduled maintenance on Friday, 10 PM - 2 AM.",
      date: "2023-09-15",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      content: "Our offices will be closed on Monday for the national holiday.",
      date: "2023-09-13",
    },
  ]);
            ...
            <div className="flex-grow overflow-y-auto px-4 pb-4">
              <div className="space-y-4 mt-4">
                {notices.map((notice) => (
                  <div
                    key={notice.id}
                    className="bg-purple-50 p-4 rounded-md relative border border-purple-200"
                  >
                    <button
